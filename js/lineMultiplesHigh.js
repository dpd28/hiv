...
function lineMultiplesHigh() { // object has curly braces, brackets are arrays
  ...
  d3.csv("data/hiv-us-rates-high.csv", convertTextToNumbers)
    .then(function (data) {
      ...
      var svg = d3.select("figure#multiples1").selectAll("svg")
        .data(states)
        .enter().append("svg")
